...
\begin{figure}[t]
\includegraphics[width=0.9\columnwidth]{figs/fig11_heatmap.pdf}
...
($N=3000$; 96 events per point, bootstrap errors).  Faster quenches
capture fewer mesons; the tetraquark yield is flat within errors
across the factor-of-four range of quench rates.}
\label{fig:scanH0}
\end{figure}
...
Across $H_0 = 0.05$--$0.20\,c/\fm$ (96 events per point) the meson
yield falls from $207.7\pm1.3$ to $180.1\pm1.0$ per event,
(anti)baryons sit at $2.5$--$3.0$ per species, and --- notably --- the
tetraquark yield is \emph{flat} at $0.55$--$0.67\pm0.08$ per event
across the full factor of four in quench rate
(Fig.~\ref{fig:scanH0}).  Five-quark states appear at every expansion
rate once both charge states are counted: $4$, $6$, and $5$
(anti)pentaquarks in the three ensembles ($0.04$--$0.06$ per event),
with no significant $H_0$ trend.  A

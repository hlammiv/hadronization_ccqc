...
charm quark ending in an ordinary charm meson.  The model thus
exhibits the classical analog of charmonium melting, and locates
$cc\bar q\bar q$ formation in the \emph{late} (regeneration) stage:
measuring it requires freeze-out-era seeding, deferred to the
$(\Gamma,\kappa)$ production study.

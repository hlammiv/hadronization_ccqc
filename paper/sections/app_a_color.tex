...
\begin{figure}[t]
\includegraphics[width=0.82\columnwidth]{figs/fig1_potentials.pdf}
...
\begin{figure}[t]
\includegraphics[width=0.82\columnwidth]{figs/fig2_static_stacked.pdf}
\caption{Static diquark-formation probability [Eq.~\eqref{eq:pstatic},
hard wall]: (top) versus per-species density at $k=\sqrt2$, (bottom)
versus the force-ratio criterion $k$ at reference density.  Lebed's
counting ($n_1{=}3n_2$, blue) and the discrete-color counting
($n_1{=}2n_2$, orange), analytic curves with ideal-gas Monte Carlo
points; crosses are Tables~1--2 of Ref.~\cite{Lebed:2016jvq},
reproduced to all quoted digits.}
\label{fig:static}
\end{figure}

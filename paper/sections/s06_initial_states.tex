...
The boundary-transient bound and the TPQ concentration statement are
derived in Appendix~\ref{app:limits}.
...
Davoudi:2025qhs}), so we present the collision as a secondary route and

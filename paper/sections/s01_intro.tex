...
First (Secs.~\ref{sec:model}--\ref{sec:classical-results}), we promote the
model to a dynamical simulation \todo{one-paragraph summary of the classical
model and headline results: species ratios, constituent-number penalty,
diquark-first fraction; quote the $100\%$-diquark-first pilot number if it
survives statistics}.
...
\todo{paragraph positioning against statistical hadronization
\cite{Andronic:2017pug} and coalescence \cite{Fries:2008hs,ExHIC:2010gcb}
predictions for exotic yields; both halves of this paper compare to those
baselines in Sec.~\ref{sec:confrontation}.}
